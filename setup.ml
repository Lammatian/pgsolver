...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3e5a15327d0d93e5f539846976561c1a) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tcsprojects/pgsolver";
          bugreports = None;
          synopsis =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/tcsprojects/pgsolver.git";
                      src_repo_browser =
                        Some "https://github.com/tcsprojects/pgsolver";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("TCSLib", None);
                           FindlibPackage ("extlib", None);
                           FindlibPackage ("ocaml-sat-solvers", None);
                           FindlibPackage ("minisat", None);
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "paritygame/Verification";
                           "paritygame/Univsolve";
                           "paritygame/Solvers";
                           "paritygame/Solverregistry";
                           "paritygame/Mdp";
                           "paritygame/Paritygamebitset";
                           "paritygame/Parsers";
                           "paritygame/Specialsolve";
                           "paritygame/Transformations";
                           "solvers/Bigstep";
                           "solvers/Dominiondecomp";
                           "solvers/Externalsolver";
                           "solvers/Fpiter";
                           "solvers/Genetic";
                           "solvers/Guessstrategy";
                           "solvers/Localmodelchecker";
                           "solvers/Optstratimprov";
                           "solvers/Prioprom";
                           "solvers/Priopromdelay";
                           "solvers/Priopromplus";
                           "solvers/Priopromrecovery";
                           "solvers/Recursive";
                           "solvers/Satsolve";
                           "solvers/Smallprogress";
                           "solvers/Stratimpralgs";
                           "solvers/Stratimprdisc";
                           "solvers/Stratimprlocal";
                           "solvers/Stratimprlocal2";
                           "solvers/Stratimprovement";
                           "solvers/Stratimprsat";
                           "solvers/Viasat";
                           "solvers/stratimpralgs/Switch_cunningham";
                           "solvers/stratimpralgs/Switch_globally_best";
                           "solvers/stratimpralgs/Switch_history";
                           "solvers/stratimpralgs/Switch_internal";
                           "solvers/stratimpralgs/Switch_locally_best";
                           "solvers/stratimpralgs/Switch_random";
                           ...
                           "generators/Laddergame";
                           "generators/Clusteredrandomgame";
                           "generators/Cliquegame";
                           "generators/Modelcheckerladder";
                           "generators/Recursiveladder";
                           "generators/Steadygame";
                           "generators/Jurdzinskigame";
                           "generators/modelchecking/Mucalculus";
                           "generators/modelchecking/Elevators";
                           "generators/modelchecking/Roadworks";
                           "generators/Towersofhanoi";
                           "generators/Langincl";
                           "generators/Recursivedullgame";
                           "generators/policyiter/Stratimprgen";
                           "generators/policyiter/Stratimprgenerators";
                           "generators/policyiter/Stratimprgenlist";
                           "generators/policyiter/generators/Zadehexp";
                           "generators/policyiter/generators/Cunninghamexp";
                           "generators/policyiter/generators/Zadehsubexp";
                           "generators/policyiter/generators/Cunninghamsubexp";
                           "generators/policyiter/generators/Fearnleysubexp";
                           "generators/policyiter/generators/Friedmannsubexp";
                           "generators/policyiter/generators/Switchallsubexp";
                           "generators/policyiter/generators/Switchbestsubexp";
                           "generators/policyiter/generators/Switchallexp";
                           "generators/policyiter/generators/Switchbestexp";
                           "generators/policyiter/generators/Randomfacetsubexp";
                           "generators/policyiter/generators/Randomedgesubexp";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/pgsolver";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pgsolver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "pgsolver.ml"});
               Executable
                 ({
                     cs_name = "solverstest-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "solverstest.ml"});
               Executable
                 ({
                     cs_name = "auso-bin";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "auso.ml"});
               Executable
                 ({
                     cs_name = "benchmark-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "benchmark.ml"});
               Executable
                 ({
                     cs_name = "benchstratimpr-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "benchstratimpr.ml"});
               Executable
                 ({
                     cs_name = "combine-bin";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "combine.ml"});
               Executable
                 ({
                     cs_name = "complexdecomp-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "complexdecomp.ml"});
               Executable
                 ({
                     cs_name = "compressor-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "compressor.ml"});
               Executable
                 ({
                     cs_name = "fullimprarena-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "fullimprarena.ml"});
               Executable
                 ({
                     cs_name = "imprarena-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "imprarena.ml"});
               Executable
                 ({
                     cs_name = "infotool-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "infotool.ml"});
               Executable
                 ({
                     cs_name = "itersat-bin";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "itersat.ml"});
               Executable
                 ({
                     cs_name = "obfuscator-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "obfuscator.ml"});
               Executable
                 ({
                     cs_name = "policyitervis-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "policyitervis.ml"});
               Executable
                 ({
                     cs_name = "transformer-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "transformer.ml"});
               Executable
                 ({
                     cs_name = "winningstrats-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "winningstrats.ml"});
               Executable
                 ({
                     cs_name = "cliquegame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "cliquegame_aux.ml"});
               Executable
                 ({
                     cs_name = "clusteredrandomgame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "clusteredrandomgame_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "jurdzinskigame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "jurdzinskigame_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "laddergame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "laddergame_aux.ml"});
               Executable
                 ({
                     cs_name = "langincl-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "langincl_aux.ml"});
               Executable
                 ({
                     cs_name = "modelcheckerladder-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "modelcheckerladder_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "randomgame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "randomgame_aux.ml"});
               Executable
                 ({
                     cs_name = "recursiveladder-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "recursiveladder_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "recursivedullgame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "recursivedullgame_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "steadygame-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "steadygame_aux.ml"});
               Executable
                 ({
                     cs_name = "towersofhanoi-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "towersofhanoi_aux.ml"
                   });
               Executable
                 ({
                     cs_name = "elevators-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/generators/modelchecking";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pgsolver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "elevators_aux.ml"});
               Executable
                 ({
                     cs_name = "roadworks-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "roadworks_aux.ml"});
               Executable
                 ({
                     cs_name = "stratimprgen-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/generators/policyiter";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pgsolver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "stratimprgen.ml"})
            ];
                      ...
                      Some
                        (("mv",
                           [
                              ...
                              ";";
                              "mv";
                              "clusteredrandomgame_aux.*";
                              "bin/clusteredrandomgame";
                              ";";
                              "mv";
                              "jurdzinskigame_aux.*";
                              "bin/jurdzinskigame";
                              ...
                              ";";
                              "mv";
                              "modelcheckerladder_aux.*";
                              "bin/modelcheckerladder";
                              ";";
                              "mv";
                              "randomgame_aux.*";
                              "bin/randomgame";
                              ";";
                              "mv";
                              "recursivedullgame_aux.*";
                              "bin/recursivedullgame";
                              ";";
                              "mv";
                              "recursiveladder_aux.*";
                              "bin/recursiveladder";
          ...
          plugins = [(`Extra, "META", None)];
          schema_data = PropList.Data.create ();
          plugin_data = []
       };
     oasis_fn = Some "_oasis";
     oasis_version = "0.4.10";
     oasis_digest = Some "\2524L\144\246\250\001l\231D)\229Of\250\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
